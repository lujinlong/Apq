<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ifTop.aspx.cs" Inherits="dtxc.User.ifTop" %>
...
<body>
	...
	<div style="width: 100%">
		...
		<div align="right">
			<a href="~/Main.htm?a=1" id="aHomeAdmin" target="_top" runat="server">管理员首页</a>
			<a href="../Logout.aspx" id="aLogout" target="_top">退出</a>
		</div>
	</div>
