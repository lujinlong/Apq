	...
	public static class GlobalObject
	{
		...
		public static Apq.Config.XmlConfig XmlAsmConfig
		{
			get
			{
				...
				{
					_XmlAsmConfig = Apq.Config.ApqConfigs.GetAsmConfig(Properties.Settings.Default.XmlAsmConfigFolder + "Apq.Web.dll.apq") as Apq.Config.XmlConfig;
				}
		...
		public static Apq.Config.XmlConfig XmlUserConfig
		{
			get
			{
				if (Properties.Settings.Default.XmlAsmConfigFolder.Length > 2)
				{
					_XmlUserConfig = Apq.Config.ApqConfigs.GetUserConfig(Properties.Settings.Default.XmlAsmConfigFolder + "Apq.Web.dll." + Environment.UserName + ".apq") as Apq.Config.XmlConfig;
				}
