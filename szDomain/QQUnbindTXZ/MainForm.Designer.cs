namespace QQUnbindTXZ
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.menuSolution = new DevExpress.XtraBars.BarButtonItem();
			...
			this.menuToolBar.Enabled = false;
			...
			this.menuSolution.Id = 0;
			this.menuSolution.Name = "menuSolution";
			this.menuSolution.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.menuSolution_ItemClick);
			// 
			// bsiTool
			// 
		...
		private DevExpress.XtraBars.BarButtonItem menuSolution;
	}
}