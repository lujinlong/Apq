namespace ApqDBManager.Forms
{
	partial class FileTrans
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FileTrans));
			this.beDBFolder_Out = new DevExpress.XtraEditors.ButtonEdit();
			this.labelControl4 = new DevExpress.XtraEditors.LabelControl();
			this.beCFolder_Out = new DevExpress.XtraEditors.ButtonEdit();
			this.labelControl1 = new DevExpress.XtraEditors.LabelControl();
			this.beDBFolder_In = new DevExpress.XtraEditors.ButtonEdit();
			this.labelControl3 = new DevExpress.XtraEditors.LabelControl();
			this.beCFolder_In = new DevExpress.XtraEditors.ButtonEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.beCFolder_In.Properties)).BeginInit();
			...
			// beDBFolder_Out
			// 
			this.beDBFolder_Out.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			this.beDBFolder_Out.EditValue = "";
			this.beDBFolder_Out.Location = new System.Drawing.Point(101, 44);
			this.beDBFolder_Out.Name = "beDBFolder_Out";
			this.beDBFolder_Out.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
			this.beDBFolder_Out.Size = new System.Drawing.Size(582, 21);
			this.beDBFolder_Out.TabIndex = 24;
			this.beDBFolder_Out.EditValueChanged += new System.EventHandler(this.beDBFolder_Out_EditValueChanged);
			// 
			// labelControl4
			// 
			...
			// beCFolder_Out
			// 
			this.beCFolder_Out.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			this.beCFolder_Out.EditValue = "";
			this.beCFolder_Out.Location = new System.Drawing.Point(101, 44);
			this.beCFolder_Out.Name = "beCFolder_Out";
			this.beCFolder_Out.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
			this.beCFolder_Out.Size = new System.Drawing.Size(582, 21);
			this.beCFolder_Out.TabIndex = 22;
			this.beCFolder_Out.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(this.beCFolder_Out_ButtonClick);
			this.beCFolder_Out.EditValueChanged += new System.EventHandler(this.beCFolder_Out_EditValueChanged);
			// 
			// labelControl1
			// 
			...
			// beDBFolder_In
			// 
			this.beDBFolder_In.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			this.beDBFolder_In.EditValue = "";
			this.beDBFolder_In.Location = new System.Drawing.Point(101, 71);
			this.beDBFolder_In.Name = "beDBFolder_In";
			this.beDBFolder_In.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
			this.beDBFolder_In.Size = new System.Drawing.Size(582, 21);
			this.beDBFolder_In.TabIndex = 28;
			this.beDBFolder_In.EditValueChanged += new System.EventHandler(this.beDBFolder_In_EditValueChanged);
			// 
			// labelControl3
			// 
			...
			// beCFolder_In
			// 
			this.beCFolder_In.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			this.beCFolder_In.EditValue = "";
			this.beCFolder_In.Location = new System.Drawing.Point(101, 71);
			this.beCFolder_In.Name = "beCFolder_In";
			this.beCFolder_In.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
			this.beCFolder_In.Size = new System.Drawing.Size(582, 21);
			this.beCFolder_In.TabIndex = 26;
			this.beCFolder_In.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(this.beCFolder_In_ButtonClick);
			this.beCFolder_In.EditValueChanged += new System.EventHandler(this.beCFolder_In_EditValueChanged);
			// 
			// labelControl2
			// 
			...
			this.groupControl1.Controls.Add(this.beCFolder_Out);
			this.groupControl1.Controls.Add(this.labelControl1);
			this.groupControl1.Controls.Add(this.btnDistribute);
			this.groupControl1.Controls.Add(this.labelControl3);
			this.groupControl1.Controls.Add(this.beDBFolder_In);
			...
			this.groupControl2.Controls.Add(this.beDBFolder_Out);
			this.groupControl2.Controls.Add(this.labelControl4);
			this.groupControl2.Controls.Add(this.btnCollect);
			this.groupControl2.Controls.Add(this.labelControl2);
			this.groupControl2.Controls.Add(this.beCFolder_In);
			...
			((System.ComponentModel.ISupportInitialize)(this.beDBFolder_Out.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.beCFolder_Out.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.beDBFolder_In.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.beCFolder_In.Properties)).EndInit();
		...
		private DevExpress.XtraEditors.ButtonEdit beDBFolder_Out;
		private DevExpress.XtraEditors.LabelControl labelControl4;
		private DevExpress.XtraEditors.ButtonEdit beCFolder_Out;
		private DevExpress.XtraEditors.LabelControl labelControl1;
		private DevExpress.XtraEditors.ButtonEdit beDBFolder_In;
		private DevExpress.XtraEditors.LabelControl labelControl3;
		private DevExpress.XtraEditors.ButtonEdit beCFolder_In;
		...
		private System.Windows.Forms.FolderBrowserDialog fbdCFolder_Out;
