...
CREATE LOGIN VcWb WITH PASSWORD = N'xDr3RFpmG7cBWJd1', SID = 0xD8F517F200CE564F839C52AF51627A63;
IF(EXISTS(SELECT TOP 1 * FROM sys.syslogins WHERE name = 'VpWs')) DROP LOGIN VpWs;
CREATE LOGIN VpWs WITH PASSWORD = N'JTh3xW9euMciHNC2', SID = 0x97C53C65C185054092DE0A0CEAC91124;
IF(EXISTS(SELECT TOP 1 * FROM sys.syslogins WHERE name = 'Pay')) DROP LOGIN Pay;
CREATE LOGIN Pay WITH PASSWORD = N'26uCBdYtF1imkLva', SID = 0x7531B6071A6485499256281857200C68;
IF(EXISTS(SELECT TOP 1 * FROM sys.syslogins WHERE name = 'Pay2')) DROP LOGIN Pay2;
CREATE LOGIN Pay2 WITH PASSWORD = N'WvEy3tda4JTf5Lwr', SID = 0x1BE583F0027763418E37C6F01A03BB5C;
IF(EXISTS(SELECT TOP 1 * FROM sys.syslogins WHERE name = 'PayWs')) DROP LOGIN PayWs;
CREATE LOGIN PayWs WITH PASSWORD = N'eMp0N2vhHftJdF8B', SID = 0xB6351CA8D6ED8542A4A8B0B7BF5984DE;
...
CREATE LOGIN BaseBusinessDb WITH PASSWORD = N'eH5rC8tBFnEAyNkJ', SID = 0x8F783C6E9BF31545ADB1F814C1161A05;
...
CREATE LOGIN AppBigMan WITH PASSWORD = N'wCcTHWvDeuNMra4B', SID = 0xA6D5D30927DFE1488A35A3E7370C8280;
