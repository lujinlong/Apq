...
IF(EXISTS(SELECT TOP 1 1 FROM sys.syslogins WHERE name = 'VcWb')) DROP LOGIN VcWb;
CREATE LOGIN VcWb WITH PASSWORD = N'xDr3RFpmG7cBWJd1', SID = 0xD8F517F200CE564F839C52AF51627A63;
IF(EXISTS(SELECT TOP 1 1 FROM sys.syslogins WHERE name = 'VpWs')) DROP LOGIN VpWs;
...
IF(EXISTS(SELECT TOP 1 1 FROM sys.syslogins WHERE name = 'AppBigMan')) DROP LOGIN AppBigMan;
