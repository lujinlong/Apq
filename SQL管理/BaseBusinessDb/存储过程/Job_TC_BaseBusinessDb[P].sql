IF( OBJECT_ID('dbo.Job_TC_BaseBusinessDb', 'P') IS NULL )
	EXEC sp_executesql N'CREATE PROCEDURE dbo.Job_TC_BaseBusinessDb AS BEGIN RETURN END';
GO
ALTER PROC dbo.Job_TC_BaseBusinessDb
AS
/* =============================================
-- 作者: 黄宗银
-- 日期: 2010-11-05
...
-- 示例:
DECLARE @rtn int;
EXEC @rtn = dbo.Job_TC_BaseBusinessDb;
SELECT @rtn;
-- =============================================
*/
SET NOCOUNT ON;
