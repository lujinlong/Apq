IF( OBJECT_ID('dbo.Apq_VarBinary_And_2k', 'FN') IS NULL )
	EXEC sp_executesql N'CREATE FUNCTION dbo.Apq_VarBinary_And_2k()RETURNS int AS BEGIN RETURN 0 END';
GO
/* =============================================
-- 作者: 黄宗银
-- 日期: 2008-06-25
...
-- =============================================
*/
ALTER FUNCTION dbo.Apq_VarBinary_And_2k(
	@vb1	varbinary(8000),
	@vb2	varbinary(8000)
...
END
GO
EXEC dbo.Apq_Def_EveryDB 'dbo', 'Apq_VarBinary_And_2k', DEFAULT
