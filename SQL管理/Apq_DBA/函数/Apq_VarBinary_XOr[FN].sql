IF( OBJECT_ID('dbo.Apq_VarBinary_XOr', 'FN') IS NULL )
	EXEC sp_executesql N'CREATE FUNCTION dbo.Apq_VarBinary_XOr()RETURNS int AS BEGIN RETURN 0 END';
GO
/* =============================================
-- 作者: 黄宗银
-- 日期: 2008-08-21
...
-- =============================================
*/
ALTER FUNCTION dbo.Apq_VarBinary_XOr(
	@vb1	varbinary(max),
	@vb2	varbinary(max)
...
END
GO
EXEC dbo.Apq_Def_EveryDB 'dbo', 'Apq_VarBinary_XOr', DEFAULT
