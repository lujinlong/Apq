/****** Object:  Job [Etl_Load]    Script Date: 11/06/2009 12:09:42 ******/
BEGIN TRANSACTION
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Etl_Load', 
		@enabled=0, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Etl_Load', 
		@step_id=1, 
