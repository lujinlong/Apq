IF( OBJECT_ID('dbo.GameWS_UserChannelPay_Today_ListPager_R1', 'P') IS NULL )
	EXEC sp_executesql N'CREATE PROCEDURE dbo.GameWS_UserChannelPay_Today_ListPager_R1 AS BEGIN RETURN END';
GO
ALTER PROC dbo.GameWS_UserChannelPay_Today_ListPager_R1
...
-- 示例:
DECLARE @rtn int;
EXEC @rtn = dbo.GameWS_UserChannelPay_Today_ListPager_R1;
SELECT @rtn;
-- =============================================
*/
SET NOCOUNT ON;
...
SELECT ID, PayWay, uid, PayToday, _Time,Imei
...
RETURN 1;
GO
GRANT EXECUTE ON [dbo].[GameWS_UserChannelPay_Today_ListPager_R1] TO GameW
GO
