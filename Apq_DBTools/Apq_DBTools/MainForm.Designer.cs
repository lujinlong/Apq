namespace Apq_DBTools
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tsmiSqlGen = new System.Windows.Forms.ToolStripMenuItem();
			...
			// tsmiSqlGen
			// 
			this.tsmiSqlGen.Name = "tsmiSqlGen";
			this.tsmiSqlGen.Size = new System.Drawing.Size(152, 22);
			this.tsmiSqlGen.Text = "脚本生成(&G)";
			this.tsmiSqlGen.Click += new System.EventHandler(this.tsmiSqlGen_Click);
			// 
			// tsmiFSRename
			// 
			this.tsmiFSRename.Name = "tsmiFSRename";
			this.tsmiFSRename.Size = new System.Drawing.Size(152, 22);
			this.tsmiFSRename.Text = "批量重命名(&H)";
			this.tsmiFSRename.Visible = false;
		...
		private System.Windows.Forms.ToolStripMenuItem tsmiSqlGen;
